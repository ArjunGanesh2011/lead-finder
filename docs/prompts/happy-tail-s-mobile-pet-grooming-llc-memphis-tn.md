# Website Build Brief - Happy Tail’s Mobile Pet Grooming LLC
...
## Business
- **Name:** Happy Tail’s Mobile Pet Grooming LLC
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a dog grooming in Memphis TN.
