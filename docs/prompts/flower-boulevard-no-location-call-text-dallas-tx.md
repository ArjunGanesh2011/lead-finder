# Website Build Brief - Flower Boulevard (no location-call/text)
...
## Business
- **Name:** Flower Boulevard (no location-call/text)
- **Industry:** florist
- **Location:** Dallas TX
...
- **Socials (wire ALL of these as buttons/icons - no dead links):**
  - Instagram: https://www.instagram.com/flower_boulevard13?igsh=MXI4aTJubjl5NDAwaA%3D%3D&utm_source=qr
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a florist in Dallas TX.
...
---
*Lead score 66.5 | no-website confidence 80.0% | buyer signal 53 | Established - good fit for Growth*
