# Website Build Brief - Cutthroat Collective Barbershop
...
## Business
- **Name:** Cutthroat Collective Barbershop
- **Industry:** barbershop
- **Location:** Nashville TN
- **Owner / contact:** (owner name not found)
- **Phone:** (confirm with client)
- **Email:** (not found - confirm with client)
- **Public description:** Check out Cutthroat Collective Barbershop and book your appointment now! Buy Products, Gift-Certificates, Memberships and more!
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a barbershop in Nashville TN.
...
- A sticky mobile "Call" bar. Embed a Google Map for Nashville TN.
