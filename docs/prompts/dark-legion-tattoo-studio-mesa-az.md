# Website Build Brief - Dark Legion Tattoo Studio
...
## Business
- **Name:** Dark Legion Tattoo Studio
- **Industry:** tattoo shop
- **Location:** Mesa AZ
- **Owner / contact:** (owner name not found)
- **Phone:** (confirm with client)
- **Email:** (not found - confirm with client)
- **Public description:** 1919 N 26th Pl Phoenix, AZ 85008 ... Pl, Phoenix Maricopa County, AZ 85008 · Manager Michael Anthony Yee 316 S Travis, Mesa Maricopa County, AZ 85208...
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a tattoo shop in Mesa AZ.
