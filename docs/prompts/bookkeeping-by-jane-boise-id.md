# Website Build Brief - Bookkeeping by Jane
...
## Business
- **Name:** Bookkeeping by Jane
- **Industry:** bookkeeping service
- **Location:** Boise ID
- **Owner / contact:** (owner name not found)
- **Phone:** (208) 807-3917
- **Email:** (not found - confirm with client)
- **Public description:** Get more information for Bookkeeping by Jane in Boise, ID. See reviews, map, get the address, and find directions.
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a bookkeeping service in Boise ID.
