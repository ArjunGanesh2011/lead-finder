# Website Build Brief - Atlanta discount furniture warehouse
...
## Business
- **Name:** Atlanta discount furniture warehouse
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a furniture store in Atlanta GA.
