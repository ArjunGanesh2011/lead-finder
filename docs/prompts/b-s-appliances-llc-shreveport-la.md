# Website Build Brief - B's Appliances LLC
...
## Business
- **Name:** B's Appliances LLC
- **Industry:** appliance repair
- **Location:** Shreveport LA
- **Owner / contact:** (owner name not found)
- **Phone:** (318) 550-1360
- **Email:** (not found - confirm with client)
- **Public description:** 2 Faves for B's Appliances LLC from neighbors in Shreveport, LA. 10 years experience repairing and selling washers and dryers in Shreveport Bossier area. Can remove non-working washers/dryers as well.
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a appliance repair in Shreveport LA.
