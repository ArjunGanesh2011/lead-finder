# Website Build Brief - Tampa Door & Hardware
...
## Business
- **Name:** Tampa Door & Hardware
- **Industry:** hardware store
- **Location:** Tampa FL
- **Owner / contact:** (owner name not found)
- **Phone:** (813) 234-1935
- **Email:** (not found - confirm with client)
- **Public description:** 4001 N Nebraska Ave Tampa, FL 33603 · Suggest an edit · People searched for Hardware Stores 1,501 times last month within 15 miles of this business.
- **Socials (wire ALL of these as buttons/icons - no dead links):**
  - Yelp: https://www.yelp.com/biz/tampa-door-and-hardware-tampa
  - Facebook: https://www.facebook.com/p/Tampa-Door-Hardware-100026565412136/
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a hardware store in Tampa FL.
...
---
*Lead score 70.5 | no-website confidence 92.0% | buyer signal 49 | Established - good fit for Growth*
