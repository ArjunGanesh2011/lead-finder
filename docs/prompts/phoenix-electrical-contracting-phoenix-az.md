# Website Build Brief - Phoenix Electrical Contracting
...
## Business
- **Name:** Phoenix Electrical Contracting
- **Industry:** electrician
- **Location:** Phoenix AZ
- **Owner / contact:** (owner name not found)
- **Phone:** (866) 650-9644
- **Email:** (not found - confirm with client)
- **Public description:** G & S Electric is a top Phoenix electrical contracting company with skilled electricians serving all cities within the greater Maricopa County.
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a electrician in Phoenix AZ.
