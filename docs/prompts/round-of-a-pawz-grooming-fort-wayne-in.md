# Website Build Brief - Round of a Pawz Grooming
...
## Business
- **Name:** Round of a Pawz Grooming
- **Industry:** dog grooming
- **Location:** Fort Wayne IN
- **Owner / contact:** (owner name not found)
- **Phone:** (260) 440-0798
- **Email:** (not found - confirm with client)
- **Public description:** Your pup is treated like family every step of the way! Located in the Georgetown area🫶🏻 · Page · Pet Groomer · 6516 Winnebago Drive, Fort Wayne, IN, United States, Indiana ·
- **Socials (wire ALL of these as buttons/icons - no dead links):**
  - Facebook: https://www.facebook.com/roundofapawzgrooming/
  - Instagram: https://www.instagram.com/roundofapawz_grooming/
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a dog grooming in Fort Wayne IN.
