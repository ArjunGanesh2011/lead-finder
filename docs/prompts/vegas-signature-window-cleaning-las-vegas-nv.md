# Website Build Brief - Vegas Signature Window Cleaning
...
## Business
- **Name:** Vegas Signature Window Cleaning
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a window cleaning in Las Vegas NV.
