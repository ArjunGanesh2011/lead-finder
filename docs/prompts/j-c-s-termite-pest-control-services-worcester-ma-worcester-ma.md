# Website Build Brief - J.C.S Termite Pest Control Services Worcester, MA
...
## Business
- **Name:** J.C.S Termite Pest Control Services Worcester, MA
- **Industry:** pest control
- **Location:** Worcester MA
- **Owner / contact:** (owner name not found)
- **Phone:** (351) 224-9573
- **Email:** (not found - confirm with client)
- **Public description:** Cylex Local Search is a complex online platform for businesses. Our aim is to connect businesses to the unique needs of their customers. Business owners can promote themselves to a huge online audience absolutely free. Users can check contact details and opening hours, read and write reviews ...
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a pest control in Worcester MA.
...
- A sticky mobile "Call" bar. Embed a Google Map for Worcester MA.
- Real, specific copy for a pest control - no lorem ipsum.

## Every interactive element must work
- Phone -> `tel:3512249573`
...
---
*Lead score 68.5 | no-website confidence 92.0% | buyer signal 45 | Lean / early-stage - best pitched Starter*
