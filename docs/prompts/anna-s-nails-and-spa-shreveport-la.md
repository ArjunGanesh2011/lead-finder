# Website Build Brief - Anna's Nails and Spa
...
## Business
- **Name:** Anna's Nails and Spa
- **Industry:** nail salon
- **Location:** Shreveport LA
- **Owner / contact:** (owner name not found)
- **Phone:** (318) 562-3909
- **Email:** (not found - confirm with client)
- **Public description:** Anna's Nails and Spa, West Hartford. 386 likes · 2 talking about this · 172 were here. We offer Nail care, Pedicures, Full Waxing and More! Call for an appointment or Walk-Ins are always welcome!
- **Socials (wire ALL of these as buttons/icons - no dead links):**
  - Facebook: https://www.facebook.com/p/Annas-Nails-and-Spa-100063768484708/
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a nail salon in Shreveport LA.
...
- A sticky mobile "Call" bar. Embed a Google Map for Shreveport LA.
- Real, specific copy for a nail salon - no lorem ipsum.

## Every interactive element must work
- Phone -> `tel:3185623909`
...
---
*Lead score 67.0 | no-website confidence 92.0% | buyer signal 42 | Lean / early-stage - best pitched Starter*
