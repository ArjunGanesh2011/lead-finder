# Website Build Brief - Bloom Auto Detailing
...
## Business
- **Name:** Bloom Auto Detailing
- **Industry:** auto detailing
- **Location:** Fresno CA
- **Owner / contact:** (owner name not found)
- **Phone:** (559) 767-8404
- **Email:** (not found - confirm with client)
- **Public description:** See Instagram photos and videos from Bloom Auto Detailing | Fresno (@bloomautodetailing)
- **Socials (wire ALL of these as buttons/icons - no dead links):**
  - Instagram: https://www.instagram.com/Bloomautodetailing/
  - Tiktok: https://www.tiktok.com/discover/bloom-auto-detailing
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a auto detailing in Fresno CA.
