# Website Build Brief - The Latin Barbers 2
...
## Business
- **Name:** The Latin Barbers 2
- **Industry:** barbershop
- **Location:** Savannah GA
- **Owner / contact:** (owner name not found)
- **Phone:** (912) 272-8120
- **Email:** (not found - confirm with client)
- **Public description:** At The Latin Barbers, we deliver high-quality haircuts and styles to highlight your personal look. Our skilled team specializes in modern, classic, and custom cuts with careful attention to detail, using the best tools and products.
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a barbershop in Savannah GA.
