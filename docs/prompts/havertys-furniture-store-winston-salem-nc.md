# Website Build Brief - Havertys Furniture Store
...
## Business
- **Name:** Havertys Furniture Store
- **Industry:** furniture store
- **Location:** Winston-Salem NC
- **Phone:** (confirm with client)
- **Public description:** false · maxWidth · section-site-width-1232px · padding · section-padding-small · /content/havertys-eds/us/en/fragments/locations/store-details/Store-Details-Bottom · section-no-padding
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a furniture store in Winston-Salem NC.
