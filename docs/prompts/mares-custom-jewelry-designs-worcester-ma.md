# Website Build Brief - Mares Custom Jewelry Designs
...
## Business
- **Name:** Mares Custom Jewelry Designs
- **Industry:** jewelry store
- **Location:** Worcester MA
- **Owner / contact:** (owner name not found)
- **Phone:** (774) 823-2079
- **Email:** (not found - confirm with client)
- **Public description:** Mares Custom Jewelry Designs Foster Street details with ⭐ 20 reviews, 📞 phone number, 📍 location on map. Find similar service centers in Worcester on Nicelocal.
- **Socials (wire ALL of these as buttons/icons - no dead links):**
  - Facebook: https://www.facebook.com/MaresCustomJewelryDesigns/
  - Instagram: https://www.instagram.com/marescustomjewelrydesigns/?hl=en
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a jewelry store in Worcester MA.
...
- Real, specific copy for a jewelry store - no lorem ipsum.

## Every interactive element must work
- Phone -> `tel:7748232079`
...
---
*Lead score 72.5 | no-website confidence 92.0% | buyer signal 53 | Established - good fit for Growth*
