# Website Build Brief - Elevated Tree Care
...
## Business
- **Name:** Elevated Tree Care
- **Industry:** tree service
- **Location:** New Orleans LA
- **Phone:** (215) 815-9440
- **Public description:** See posts, photos and more on Facebook
- **Socials (wire ALL of these as buttons/icons - no dead links):**
  - Facebook: https://www.facebook.com/elevatedtreecarenola/
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a tree service in New Orleans LA.
