# Website Build Brief - LoneStar Automotive
...
## Business
- **Name:** LoneStar Automotive
- **Industry:** auto repair shop
- **Location:** El Paso TX
- **Owner / contact:** (owner name not found)
- **Phone:** (915) 234-7989
- **Email:** (not found - confirm with client)
- **Public description:** Read 50 customer reviews of LoneStar Automotive, one of the best Automotive businesses at 900 Hawkins A #1, El Paso, TX 79915 United States. Find reviews, ratings, directions, business hours, and book appointments online.
- **Socials (wire ALL of these as buttons/icons - no dead links):**
  - Yelp: https://www.yelp.com/biz/lonestar-automotive-dallas
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a auto repair shop in El Paso TX.
...
- Real, specific copy for a auto repair shop - no lorem ipsum.

## Every interactive element must work
- Phone -> `tel:9152347989`
