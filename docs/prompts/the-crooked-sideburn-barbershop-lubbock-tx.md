# Website Build Brief - The Crooked Sideburn Barbershop
...
## Business
- **Name:** The Crooked Sideburn Barbershop
- **Industry:** barbershop
- **Location:** Lubbock TX
- **Owner / contact:** (owner name not found)
- **Phone:** (806) 777-2741
- **Email:** (not found - confirm with client)
- **Public description:** Get more information for The Crooked Sideburn Barbershop in Lubbock, TX. See reviews, map, get the address, and find directions.
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a barbershop in Lubbock TX.
