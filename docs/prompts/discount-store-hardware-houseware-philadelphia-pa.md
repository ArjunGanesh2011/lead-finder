# Website Build Brief - Discount Store Hardware & Houseware
...
## Business
- **Name:** Discount Store Hardware & Houseware
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a hardware store in Philadelphia PA.
