# Website Build Brief - Sunshine Window Cleaning Company
...
## Business
- **Name:** Sunshine Window Cleaning Company
- **Industry:** window cleaning
- **Location:** Louisville KY
- **Owner / contact:** (owner name not found)
- **Phone:** (502) 895-7982
- **Email:** (not found - confirm with client)
- **Public description:** Sunshine Window Cleaning Company, Louisville, Kentucky. 21 likes · 2 were here. For over 30 years, Sunshine Window Cleaning has served 1000’s of wonderful customers in the Kentuckiana with an...
- **Socials (wire ALL of these as buttons/icons - no dead links):**
  - Facebook: https://www.facebook.com/SunshineWindowCleaningCompany/
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a window cleaning in Louisville KY.
...
- A sticky mobile "Call" bar. Embed a Google Map for Louisville KY.
- Real, specific copy for a window cleaning - no lorem ipsum.

## Every interactive element must work
- Phone -> `tel:5028957982`
