# Website Build Brief - Omaha Emergency Neighborhood Plumbers
...
## Business
- **Name:** Omaha Emergency Neighborhood Plumbers
- **Industry:** plumber
- **Location:** Omaha NE
- **Owner / contact:** (owner name not found)
- **Phone:** (402) 256-6236
- **Email:** (not found - confirm with client)
- **Public description:** Get more information for Omaha Emergency Neighborhood Plumbers LC in Omaha, NE. See reviews, map, get the address, and find directions.
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a plumber in Omaha NE.
...
- Real, specific copy for a plumber - no lorem ipsum.

## Every interactive element must work
- Phone -> `tel:4022566236`
