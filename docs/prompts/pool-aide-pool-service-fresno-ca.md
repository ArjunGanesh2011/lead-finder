# Website Build Brief - Pool-Aide Pool Service
...
## Business
- **Name:** Pool-Aide Pool Service
- **Industry:** pool service
- **Location:** Fresno CA
- **Owner / contact:** (owner name not found)
- **Phone:** (559) 477-7768
- **Email:** (not found - confirm with client)
- **Public description:** Pool-Aide Pool Service, Fresno, California. 63 likes. Swimming Pool & Hot Tub Service
- **Socials (wire ALL of these as buttons/icons - no dead links):**
  - Facebook: https://www.facebook.com/people/Pool-Aide-Pool-Service/100069762985390/
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a pool service in Fresno CA.
...
- Real, specific copy for a pool service - no lorem ipsum.

## Every interactive element must work
- Phone -> `tel:5594777768`
