# Website Build Brief - Taquería Rosita's | Mexican Food Truck
...
## Business
- **Name:** Taquería Rosita's | Mexican Food Truck
- **Industry:** food truck
- **Location:** Tucson AZ
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a food truck in Tucson AZ.
