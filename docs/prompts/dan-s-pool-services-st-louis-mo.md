# Website Build Brief - Dan's Pool Services
...
## Business
- **Name:** Dan's Pool Services
- **Industry:** pool service
- **Location:** St Louis MO
- **Phone:** (314) 849-5699
- **Public description:** 12 Faves for Dan's Pool Services from neighbors in St. Louis, MO. Connect with neighborhood businesses on Nextdoor.
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a pool service in St Louis MO.
