# Website Build Brief - Heise Bookkeeping and Tax Service
...
## Business
- **Name:** Heise Bookkeeping and Tax Service
- **Industry:** bookkeeping service
- **Location:** Omaha NE
- **Owner / contact:** (owner name not found)
- **Phone:** (402) 650-1072
- **Email:** (not found - confirm with client)
- **Public description:** Omaha Business Directory · Find an accountant in Omaha
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a bookkeeping service in Omaha NE.
