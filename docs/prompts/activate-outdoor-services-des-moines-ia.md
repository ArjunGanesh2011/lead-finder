# Website Build Brief - Activate Outdoor Services
...
## Business
- **Name:** Activate Outdoor Services
...
- **Socials (wire ALL of these as buttons/icons - no dead links):**
  - Yelp: https://www.yelp.com/biz/activate-outdoor-services-des-moines?override_cta=Get+a+quote
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a pressure washing in Des Moines IA.
