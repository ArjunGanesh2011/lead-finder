# Website Build Brief - Low Cost Auto Insurance Source
...
## Business
- **Name:** Low Cost Auto Insurance Source
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a insurance agency in Portland OR.
