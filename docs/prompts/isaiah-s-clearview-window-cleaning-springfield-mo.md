# Website Build Brief - Isaiah’s ClearView Window Cleaning
...
## Business
- **Name:** Isaiah’s ClearView Window Cleaning
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a window cleaning in Springfield MO.
