# Website Build Brief - FlowersbyGissela
...
## Business
- **Name:** FlowersbyGissela
- **Industry:** florist
- **Location:** Indianapolis IN
- **Owner / contact:** (owner name not found)
- **Phone:** (317) 646-7161
- **Email:** (not found - confirm with client)
- **Public description:** TikTok video from 💞Flowers _by _Gissela🌹 (@flowersbygissela)
- **Socials (wire ALL of these as buttons/icons - no dead links):**
  - Tiktok: https://www.tiktok.com/@flowersbygissela/video/7561162358421212471
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a florist in Indianapolis IN.
