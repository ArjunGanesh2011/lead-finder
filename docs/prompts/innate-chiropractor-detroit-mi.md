# Website Build Brief - Innate Chiropractor
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a chiropractor in Detroit MI.
...
- Real, specific copy for a chiropractor - no lorem ipsum.

## Every interactive element must work
- Phone -> `tel:3133662247`
