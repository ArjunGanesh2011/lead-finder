# Website Build Brief - Lazy Day Health and Beauty Spa
...
## Business
- **Name:** Lazy Day Health and Beauty Spa
- **Industry:** day spa
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a day spa in Shreveport LA.
...
- Real, specific copy for a day spa - no lorem ipsum.

## Every interactive element must work
- Phone -> `tel:3322867988`
