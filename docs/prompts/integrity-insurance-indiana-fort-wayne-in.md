# Website Build Brief - Integrity Insurance Indiana
...
## Business
- **Name:** Integrity Insurance Indiana
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a insurance agency in Fort Wayne IN.
