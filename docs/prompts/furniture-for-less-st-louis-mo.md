# Website Build Brief - Furniture For Less
...
## Business
- **Name:** Furniture For Less
- **Industry:** furniture store
- **Location:** St Louis MO
- **Owner / contact:** (owner name not found)
- **Phone:** (314) 868-8199
- **Email:** (not found - confirm with client)
- **Public description:** More · Posts · About · Photos · Furniture for LESS · Furniture For Less established since 2002. We carry Ashley, Benchcraft, and Simmons Furniture. Page · Furniture store · 9020 W Florissant Ave, St.
- **Socials (wire ALL of these as buttons/icons - no dead links):**
  - Facebook: https://www.facebook.com/FurnitureForLessMO/
  - Yelp: https://www.yelp.com/biz/furniture-for-less-saint-louis-4
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a furniture store in St Louis MO.
...
---
*Lead score 67.5 | no-website confidence 92.0% | buyer signal 43 | Lean / early-stage - best pitched Starter*
