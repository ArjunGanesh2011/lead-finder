# Website Build Brief - Chris's Tree Service
...
## Business
- **Name:** Chris's Tree Service
- **Industry:** tree service
- **Location:** Winston-Salem NC
- **Owner / contact:** (owner name not found)
- **Phone:** (336) 847-1961
- **Email:** (not found - confirm with client)
- **Public description:** See reviews for CHRIS'S TREE SERVICE in Winston Salem, NC at 6883 N NC HIghway 109 from Angi members or join today to leave your own review.
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a tree service in Winston-Salem NC.
