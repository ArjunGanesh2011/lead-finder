# Website Build Brief - Shreveport's Roofing Pros
...
## Business
- **Name:** Shreveport's Roofing Pros
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a roofing company in Shreveport LA.
...
- Real, specific copy for a roofing company - no lorem ipsum.

## Every interactive element must work
- Phone -> `tel:3182258125`
...
---
*Lead score 80.5 | no-website confidence 80.0% | buyer signal 81 | High earner - comfortably fits Premium*
