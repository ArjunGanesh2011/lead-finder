# Website Build Brief - Des Moines Car Detail
...
## Business
- **Name:** Des Moines Car Detail
- **Industry:** auto detailing
- **Location:** Des Moines IA
- **Owner / contact:** (owner name not found)
- **Phone:** (515) 207-0309
- **Email:** (not found - confirm with client)
- **Public description:** Razzle Dazzle Detailing is a professional car detailing service based in Des Moines, IA. They specialize in providing thorough cleaning and restoration services for vehicles of all makes and models.
- **Socials (wire ALL of these as buttons/icons - no dead links):**
  - Yelp: https://www.yelp.com/biz/des-moines-car-detail-des-moines
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a auto detailing in Des Moines IA.
...
- A sticky mobile "Call" bar. Embed a Google Map for Des Moines IA.
- Real, specific copy for a auto detailing - no lorem ipsum.

## Every interactive element must work
- Phone -> `tel:5152070309`
...
---
*Lead score 69.0 | no-website confidence 92.0% | buyer signal 46 | Lean / early-stage - best pitched Starter*
