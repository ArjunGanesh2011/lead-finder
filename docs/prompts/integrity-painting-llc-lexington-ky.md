# Website Build Brief - Integrity Painting LLC
...
- **Socials (wire ALL of these as buttons/icons - no dead links):**
  - Facebook: https://www.facebook.com/profile.php?id=100091585840924
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a painting company in Lexington KY.
...
- A sticky mobile "Call" bar. Embed a Google Map for Lexington KY.
- Real, specific copy for a painting company - no lorem ipsum.

## Every interactive element must work
- Phone -> `tel:8599538571`
