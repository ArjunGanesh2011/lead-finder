# Website Build Brief - Pikes Peak Gift Shop
...
## Business
- **Name:** Pikes Peak Gift Shop
- **Industry:** gift shop
- **Location:** Colorado Springs CO
- **Owner / contact:** (owner name not found)
- **Phone:** (confirm with client)
- **Email:** (not found - confirm with client)
- **Public description:** Could anyone tell me the name of the brand of soaps on top of Pikes Peak in the gift shop? I want to order another bar of this because I like it so…
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a gift shop in Colorado Springs CO.
...
- A sticky mobile "Call" bar. Embed a Google Map for Colorado Springs CO.
