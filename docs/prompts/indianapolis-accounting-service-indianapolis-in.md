# Website Build Brief - Indianapolis Accounting Service
...
## Business
- **Name:** Indianapolis Accounting Service
- **Industry:** bookkeeping service
- **Location:** Indianapolis IN
- **Owner / contact:** (owner name not found)
- **Phone:** (317) 542-3154
- **Email:** (not found - confirm with client)
- **Public description:** People use Yelp to search for everything from the city's tastiest burger to the most renowned cardiologist. What will you uncover in your neighborhood?
- **Socials (wire ALL of these as buttons/icons - no dead links):**
  - Yelp: https://www.yelp.com/biz/indianapolis-accounting-service-indianapolis
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a bookkeeping service in Indianapolis IN.
...
- A sticky mobile "Call" bar. Embed a Google Map for Indianapolis IN.
- Real, specific copy for a bookkeeping service - no lorem ipsum.

## Every interactive element must work
- Phone -> `tel:3175423154`
...
---
*Lead score 62.0 | no-website confidence 92.0% | buyer signal 32 | Lean / early-stage - best pitched Starter*
