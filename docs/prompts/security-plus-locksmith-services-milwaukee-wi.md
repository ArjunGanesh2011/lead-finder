# Website Build Brief - Security-Plus Locksmith Services
...
## Business
- **Name:** Security-Plus Locksmith Services
- **Industry:** locksmith
- **Location:** Milwaukee WI
- **Owner / contact:** (owner name not found)
- **Phone:** (414) 282-7778
- **Email:** (not found - confirm with client)
- **Public description:** Security Plus Locksmith is a company that operates in the Security Products & Services industry. It employs 10to19 people and has 1Mto5M of revenue. The company is headquartered in Milwaukee, Wisconsin.Explore moreSecurity Plus Locksmith's Social Media
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a locksmith in Milwaukee WI.
...
- Real, specific copy for a locksmith - no lorem ipsum.

## Every interactive element must work
- Phone -> `tel:4142827778`
