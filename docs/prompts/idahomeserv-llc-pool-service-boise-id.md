# Website Build Brief - IdaHomeServ LLc Pool Service
...
## Business
- **Name:** IdaHomeServ LLc Pool Service
- **Industry:** pool service
- **Location:** Boise ID
- **Phone:** (confirm with client)
- **Public description:** 2 Faves for IdaHomeServ LLc Pool Service from neighbors in Boise, ID. IdaHomeServLLC was was created March, 2019 out of Boise, Idaho. We decided to start our own pool service company and it has been an incredible experience.
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a pool service in Boise ID.
