# Website Build Brief - David C Hinton, CPA PA
...
## Business
- **Name:** David C Hinton, CPA PA
- **Industry:** accounting firm
- **Location:** Winston-Salem NC
- **Owner / contact:** (owner name not found)
- **Phone:** (336) 724-4261
- **Email:** (not found - confirm with client)
- **Public description:** David Hinton is associated with David C Hinton, CPA PA. ... David Hinton’s primary location is Winston Salem, NC.
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a accounting firm in Winston-Salem NC.
