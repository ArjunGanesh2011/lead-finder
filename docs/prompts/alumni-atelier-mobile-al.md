# Website Build Brief - Alumni Atelier
...
## Business
- **Name:** Alumni Atelier
- **Industry:** bridal shop
- **Location:** Mobile AL
- **Owner / contact:** (owner name not found)
- **Phone:** (251) 422-7565
- **Email:** (not found - confirm with client)
- **Public description:** Alumni Atelier, Mobile, Alabama. 216 likes · 8 talking about this. Alumni Atelier excels in alterations and custom clothing such as shirts, pants, jackets, and more..
- **Socials (wire ALL of these as buttons/icons - no dead links):**
  - Facebook: https://www.facebook.com/AlumniAtelier/
  - Instagram: https://www.instagram.com/alumniatelier/
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a bridal shop in Mobile AL.
...
- Real, specific copy for a bridal shop - no lorem ipsum.

## Every interactive element must work
- Phone -> `tel:2514227565`
