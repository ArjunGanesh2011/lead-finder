# Website Build Brief - JDog Junk Removal and Hauling Shreveport
...
## Business
- **Name:** JDog Junk Removal and Hauling Shreveport
...
- **Socials (wire ALL of these as buttons/icons - no dead links):**
  - Facebook: https://www.facebook.com/jdogshreveport
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a junk removal in Shreveport LA.
