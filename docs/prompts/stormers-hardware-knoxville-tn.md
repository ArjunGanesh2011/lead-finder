# Website Build Brief - Stormers Hardware
...
## Business
- **Name:** Stormers Hardware
- **Industry:** hardware store
- **Location:** Knoxville TN
- **Owner / contact:** (owner name not found)
- **Phone:** (865) 933-4867
- **Email:** (not found - confirm with client)
- **Public description:** Stormers Hardware in Knoxville stands out as a local hardware store resource for home and project needs. Positioned as a neighborhood-focused business, it reflects the practical, solution-oriented spirit often highlighted in hardware store blogs.
- **Socials (wire ALL of these as buttons/icons - no dead links):**
  - Instagram: https://www.instagram.com/p/DG26i1zTjqN/
  - Facebook: https://www.facebook.com/stormershardware/
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a hardware store in Knoxville TN.
...
- A sticky mobile "Call" bar. Embed a Google Map for Knoxville TN.
- Real, specific copy for a hardware store - no lorem ipsum.

## Every interactive element must work
- Phone -> `tel:8659334867`
...
---
*Lead score 74.0 | no-website confidence 92.0% | buyer signal 56 | Established - good fit for Growth*
