# Website Build Brief - Schmig Bookkeeping Services
...
## Business
- **Name:** Schmig Bookkeeping Services
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a bookkeeping service in Spokane WA.
