# Website Build Brief - Q-NOLOGY Nail Studio
...
- **Public description:** Get more information for Q-NOLOGY Nail Studio in Richmond, VA. See reviews, map, get the address, and find directions.
- **Socials (wire ALL of these as buttons/icons - no dead links):**
  - Instagram: https://www.instagram.com/q.nology/
  - Facebook: https://www.facebook.com/p/Q-Nology-Nail-Studio-61585325378028/
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a nail salon in Richmond VA.
