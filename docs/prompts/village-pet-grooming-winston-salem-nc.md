# Website Build Brief - Village pet grooming
...
skills. This is a paid **Starter** client site ($800 build + $150/mo)
- it must look the part.

## Business
- **Name:** Village pet grooming
- **Industry:** dog grooming
- **Location:** Winston-Salem NC
- **Owner / contact:** (owner name not found)
- **Phone:** (336) 766-8100
- **Email:** (not found - confirm with client)
- **Public description:** Looking for a new groomer for my pups...suggestions please · Tresa M. replied: ... Linda M. replied: Ruff Housing on Witt St. Side street opposite Arby's on Knollwood. Rick B. replied: Donna Fraley at Village Pet Grooming in Clemmons is fantastic!
- **Socials (wire ALL of these as buttons/icons - no dead links):**
  - Yelp: https://www.yelp.com/search?cflt=groomer&find_loc=Winston-Salem,+NC+27103
  - Facebook: https://www.facebook.com/share/17mNckgybp/?mibextid=wwXIfr

## Brand
- **Logo:** none found - design a clean wordmark/logo for the business
- **Suggested palette (extracted from their socials):** none extracted - derive a tasteful palette fitting the niche
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a dog grooming in Winston-Salem NC.
...
## Pages (Starter tier - build all)
- Home
- About
- Contact

Keep it tight and high-impact: one strong scrolling home page experience plus About and Contact. Every section animated.
...
- A sticky mobile "Call" bar. Embed a Google Map for Winston-Salem NC.
- Real, specific copy for a dog grooming - no lorem ipsum.

## Every interactive element must work
- Phone -> `tel:3367668100`
...
---
*Lead score 65.5 | no-website confidence 92.0% | buyer signal 39 | Lean / early-stage - best pitched Starter*
