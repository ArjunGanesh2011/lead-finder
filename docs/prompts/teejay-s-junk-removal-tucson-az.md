# Website Build Brief - TeeJay's Junk Removal
...
## Business
- **Name:** TeeJay's Junk Removal
- **Industry:** junk removal
- **Location:** Tucson AZ
- **Phone:** (520) 304-5500
- **Public description:** Specialties: TeeJay’s Junk Removal specializes in professional junk removal and property cleanouts throughout Tucson and the surrounding areas. We handle yard debris removal, garage cleanouts, furniture and appliance hauling, rental property ...
- **Socials (wire ALL of these as buttons/icons - no dead links):**
  - Yelp: https://www.yelp.com/biz/teejays-junk-removal-tucson
  - Facebook: https://www.facebook.com/TeeJaysJunkRemoval/
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a junk removal in Tucson AZ.
...
- A sticky mobile "Call" bar. Embed a Google Map for Tucson AZ.
- Real, specific copy for a junk removal - no lorem ipsum.

## Every interactive element must work
- Phone -> `tel:5203045500`
