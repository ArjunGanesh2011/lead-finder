# Website Build Brief - Cruz yard maintenance
...
## Business
- **Name:** Cruz yard maintenance
- **Industry:** lawn care service
- **Location:** Fresno CA
...
- **Socials (wire ALL of these as buttons/icons - no dead links):**
  - Yelp: https://www.yelp.com/biz/cruz-yard-maintenance-fresno
...
- If the logo image is a URL, fetch it and base the palette + favicon on it.
  ...
  appropriate for a lawn care service in Fresno CA.
...
- A sticky mobile "Call" bar. Embed a Google Map for Fresno CA.
- Real, specific copy for a lawn care service - no lorem ipsum.

## Every interactive element must work
- Phone -> `tel:5598004225`
